...
const Login = () => {
    ...
    return (
        <div>
            {userLoggedIn && (<Link href={'/'} replace={true} />)}
            ...
            <main className="w-full h-screen flex self-center place-content-center place-items-center">
                <div className="w-96 text-gray-300 space-y-5 p-4 shadow-xl border rounded-xl">
                    ...
                    <button
                        ...
                        className={`w-full flex items-center justify-center gap-x-3 py-2.5 border rounded-lg text-sm font-medium  ${isSigningIn ? 'cursor-not-allowed' : 'hover:bg-gray-100 hover:text-dark-5 transition duration-300 active:bg-gray-100'}`}>
